...
def getArguments():
	...
	myparse.add_argument("--ipField", help="Enter a ip field. Ex: 192.168.1.0/24")
	myparse.add_argument("--outFile", help="Enter a file Ex: scanresults.txt")
	myparse.add_argument("--getHostname", help="Do you want to know the hostname?  Ex: y or n")
	myparse.add_argument("--interface", help="Enter the interface name to use (Ex: wlan0, 'Wi-Fi 2')")
...
def show_ip_mac_vendor(res):
	...
	print("\n\n\n", "_" * 144, file=outputt)
	print("|_______IP________|".ljust(26), "|_______MAC_______|      ",  "|" + "______VENDOR______".center(91, "_") + "|", file=outputt)
	...
	for sent, received in res:
		...
		l = "|" + srcIP.center(30) + " >    " + srcMAC + "    >    " + v.center(100) + "|"
...
def show_ip_mac_vendor_hostname(res):
	...
	print("\n\n\n", "_" * 138, file=outputt)
	print("|_____HOSTNAME_____|".ljust(26), "|_______IP________|".ljust(23), "|_______MAC_______|      ",  "|" + "______VENDOR______".center(61, "_") + "|", file=outputt)
	...
	for sent, received in res:
		...
		l = "|" + hN.center(28) + "   >    " + srcIP.ljust(29) + ">   " + srcMAC + "    >   " + v.center(71) + "|"
		print(l, file=outputt)
...
if ((ipField != None) and (ip_control())):
	...
	if (hostN in ("y", "n")):
		...
		if (not terminalColorDt()):
				r = input("You are using Windows and your terminal color may look distorted, do you want to continue? [y/press any key]: ").strip().casefold()
